  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-between font-body game-background">
      ...
      <div className="w-full min-h-screen relative isolate overflow-hidden p-3 lg:p-8 shadow-2xl flex flex-col justify-start">
        <h1 className="mx-auto text-4xl sm:text-8xl lg:text-9xl font-bold font-display leading-none tracking-wide game-title w-full text-left sm:text-center sm:w-auto" style={{ color: 'red' }}>
          Luxe Townhouse
        </h1>

        <div className="max-w-xs md:max-w-xl lg:max-w-none mx-auto my-4 text-center text-base sm:text-xl md:text-2xl text-white leading-tight shadow-solid">
        An artificial intelligence-based community where virtual characters reside, engage in conversations, and interact socially.
          <Unauthenticated>
